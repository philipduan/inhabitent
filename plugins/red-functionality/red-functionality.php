 ...
 * @since 1.0.0
 */
include_once( RF_DIR . '/lib/functions/post_type_adventure.php' );
include_once( RF_DIR . '/lib/functions/post_type_journal.php' );
include_once( RF_DIR . '/lib/functions/post_type_product.php' );
include_once( RF_DIR . '/lib/functions/post_type_contact_info.php' );
include_once( RF_DIR . '/lib/functions/post_type_business_hours.php' );
 ...
 * @since 1.0.0
 */
include_once( RF_DIR . '/lib/functions/taxonomie_product.php' );
