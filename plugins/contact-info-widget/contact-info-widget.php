...
class Contact_Info extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$gg_page = empty( $instance['gg_page'] ) ? '' : apply_filters( 'widget_title', $instance['gg_page'] );
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['gg_page'] = strip_tags( $new_instance['gg_page'] );
	...
	public function form( $instance ) {
		...
		$tel_number = strip_tags( $new_instance['tel_number'] );
