 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Business Hour Widget
 * Plugin URI:        @TODO
...
class Business_Hours extends WP_Widget {
	...
	public function form( $instance ) {
		...
		$monday_friday = strip_tags( $new_instance['monday_friday'] );
		$saturday = strip_tags( $new_instance['saturday'] );
		$sunday = strip_tags( $new_instance['sunday'] );
